...
const Small = (props) => (
  ...
  >
    ...
    { (props.perms.indexOf("manageStudents") !== -1) ?  (<MenuItem  primaryText="Upload Students" containerElement='label'  containerElement={<Link to="/uploadstudents"/>} />) : ''}
    { (props.perms.indexOf("createAccounts") !== -1) ?  (<MenuItem  primaryText="Manage Users"  containerElement={<Link to="/manageusers"/>} />) : ''}
    <MenuItem   primaryText="Logout" onTouchTap={props.handleLogout} />
  </IconMenu>
);

const Normal = (props, state) => (<div className="menu-on-normal-screen">
                     ...
                     { (props.perms.indexOf("createAccounts") !== -1) ?  (<div><RaisedButton onTouchTap={props.handleOpenMenu} label="Admin" /><Menu
          open={state.openMenu}
          onRequestChange={props.handleOnRequestChange}
        >
          <MenuItem value="1" containerElement='label' label="Manage Users"  containerElement={<Link to="/manageusers"/>}/>
       ...
       return (<div>
                  <AppBar className={this.props.loggedin ? "sticky-navbar sticky-navbar-loggedin" : "sticky-navbar"}
                    ...
                    iconElementRight={<div>{this.props.loggedin && this.props.perms ? 
                      (<div><Small {...this.props} /><Normal {...this.props} {...this.state} handleOpenMenu={this.handleOpenMenu} handleOnRequestChange={this.handleOnRequestChange}/></div>)  : (<div className="placeholder"></div>) } </div>}
                    />     
...
{/* <IconMenu
        ...
        <RaisedButton onTouchTap={this.handleOpenMenu} label="Admin" /> */}